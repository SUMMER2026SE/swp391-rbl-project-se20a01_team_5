...
import { Bus, Menu, Bell, Search, UserCircle, LogOut } from 'lucide-react';
        ...
        <header className="bg-white rounded-3xl p-4 px-6 md:px-8 shadow-sm border border-black/5 flex items-center justify-between mb-4 md:mb-6 shrink-0 h-24">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-12 h-12 rounded-2xl bg-brand-primary flex items-center justify-center text-brand-text font-bold text-lg border border-black/5">
                U
              </div>
            </div>
          </div>
