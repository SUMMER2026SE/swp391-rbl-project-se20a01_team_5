...
export const NAV_CONFIG: Record<Role, NavItem[]> = {
  ...
  admin: [
    ...
    { id: "adm-risk", label: "Khiếu nại & vi phạm", icon: ShieldAlert, group: "Vận hành rủi ro" },
  ...
  university_admin: [
    ...
    { id: "uniadm-import", label: "Import danh sách SV", icon: FileSpreadsheet, group: "Sinh viên" },
    { id: "uniadm-roster", label: "Danh sách sinh viên", icon: Users, group: "Sinh viên" },
    { id: "uniadm-subsidy", label: "Chính sách trợ giá", icon: Percent, group: "Tài chính & đối soát" },
    { id: "uniadm-recon", label: "Đối soát tài chính", icon: FileBarChart, group: "Tài chính & đối soát" },
    { id: "uniadm-transactions", label: "Lịch sử giao dịch", icon: Receipt, group: "Tài chính & đối soát" },
    { id: "uniadm-stats", label: "Thống kê sử dụng", icon: BarChart3, group: "Tổng quan" },
    { id: "uniadm-notify", label: "Gửi thông báo cho sinh viên", icon: Megaphone, group: "Truyền thông" },
  ],
};
