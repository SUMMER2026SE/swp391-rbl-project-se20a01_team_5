...
import { Activity, Bell, CalendarDays, MapPin, MessageSquare } from 'lucide-react';
...
export default function CoordinatorLayout({ children }) {
  const menus = [
    ...
    { name: 'Tuyến & Trạm dừng', href: '/coordinator/routes', icon: MapPin },
    { name: 'Thông báo', href: '/coordinator/notifications', icon: Bell },
