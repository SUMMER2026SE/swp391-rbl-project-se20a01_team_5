...
const INITIAL_FEEDBACKS = [
  { id: 'FB01', type: 'lost_item', user: 'Nguyễn Văn A', time: '10 phút trước', content: 'Tôi để quên một chiếc ô màu đen ở hàng ghế số 3 bên trái trên Tuyến 1.', status: 'pending' },
  { id: 'FB02', type: 'sos', user: 'Tài xế Nguyễn Văn Tài', time: '25 phút trước', content: 'Xe 43B-123.45 bị hỏng lốp tại Ngã Ba Huế, cần hỗ trợ xe thay thế gấp!', status: 'resolved' },
  { id: 'FB03', type: 'general', user: 'Lê Thị C', time: '1 giờ trước', content: 'Hôm nay xe tuyến 2 chạy rất êm, bác tài thân thiện. Đánh giá 5 sao!', status: 'pending' },
  { id: 'FB04', type: 'general', user: 'Trần Văn B', time: '2 giờ trước', content: 'Ứng dụng trên điện thoại đôi khi cập nhật vị trí xe hơi chậm.', status: 'resolved' },
];
...
export default function CoordinatorFeedbackPage() {
  ...
  const handleSendNotification = (e) => {
    ...
    setTimeout(() => {
      ...
      setNotifyTitle('');
      setNotifyContent('');
      alert('Đã gửi thông báo Push Notification thành công!');
    }, 1000);
  };
