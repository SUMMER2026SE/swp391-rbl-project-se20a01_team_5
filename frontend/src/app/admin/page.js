...
import { PieChart, Users, BusFront, Wallet, TrendingUp, Activity, ArrowUpRight, ArrowDownRight } from 'lucide-react';

export default function AdminDashboardPage() {
  
  // Dữ liệu giả lập cho biểu đồ doanh thu (CSS Bar Chart)
  const revenueData = [
    { day: 'T2', amount: 12000000, height: '60%' },
    { day: 'T3', amount: 15000000, height: '75%' },
    { day: 'T4', amount: 18000000, height: '90%' },
    { day: 'T5', amount: 14000000, height: '70%' },
    { day: 'T6', amount: 20000000, height: '100%' },
    { day: 'T7', amount: 8000000, height: '40%' },
    { day: 'CN', amount: 5000000, height: '25%' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 shrink-0">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 relative overflow-hidden group hover:border-brand-primary/50 transition-colors">
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
              ...
              <div className="flex items-center gap-1 text-sm font-bold text-brand-success bg-brand-success/10 px-2 py-1 rounded-lg">
            ...
            <div className="text-3xl font-black text-brand-text relative z-10">24.500.000₫</div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 relative overflow-hidden group hover:border-brand-primary/50 transition-colors">
            ...
            <div className="text-3xl font-black text-brand-text relative z-10">12,450</div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 relative overflow-hidden group hover:border-brand-primary/50 transition-colors">
            ...
            <div className="text-3xl font-black text-brand-text relative z-10">85</div>
          </div>
          ...
          <div className="bg-brand-text rounded-3xl p-6 shadow-lg border border-black/5 relative overflow-hidden group">
            ...
            <div className="text-3xl font-black text-white relative z-10">142 <span className="text-sm font-bold text-white/40">chuyến</span></div>
          </div>
              ...
              <div className="w-full flex flex-col gap-3">
                <div className="flex items-center justify-between p-3 bg-brand-surface rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-sm">ĐH Bách Khoa</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-brand-surface rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-sm">ĐH Kinh tế</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-brand-surface rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-sm">ĐH Sư phạm</span>
                  </div>
