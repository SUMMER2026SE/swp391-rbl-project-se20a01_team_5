    ...
    <div className="h-full flex flex-col gap-6 font-sans relative">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-brand-text/60 font-medium">Theo dõi các thay đổi lịch trình, tuyến xe và thông tin khẩn cấp.</p>
        </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <h2 className="font-bold text-lg text-brand-text">{notification.title}</h2>
                      </div>
                      <p className="mt-2 text-sm font-medium text-brand-text/70">{notification.content}</p>
                    </div>
