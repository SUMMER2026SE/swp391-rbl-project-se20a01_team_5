      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto custom-scrollbar pr-2 pb-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-black/5 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold text-brand-text">Lê Thị Phụ Xe</h2>
            ...
            <div className="w-full flex flex-col gap-3 text-left">
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold">PX-2005</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold">0905 555 666</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold truncate max-w-[200px]">phuxe@unibus.vn</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">150</div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">480</div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">98%</div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-black/5 flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border border-black/5 rounded-2xl p-4 flex items-start gap-4 hover:border-brand-primary transition-colors">
                ...
                <div>
                  <div className="font-bold">Kỹ năng Sơ cấp cứu</div>
                  <div className="text-sm text-brand-text/60 mt-1">Cấp ngày: 15/06/2023</div>
                  <div className="text-sm font-bold text-brand-success mt-1">Còn hạn</div>
                </div>
              </div>
              ...
              <div className="border border-black/5 rounded-2xl p-4 flex items-start gap-4 hover:border-brand-primary transition-colors">
                ...
                <div>
                  <div className="font-bold">Chứng nhận An toàn PCCC</div>
                  <div className="text-sm text-brand-text/60 mt-1">Trung tâm PCCC Đà Nẵng</div>
                  <div className="text-sm font-bold text-brand-success mt-1">Đạt yêu cầu</div>
                </div>
              </div>
            </div>
