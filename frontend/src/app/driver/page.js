        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-black/5 flex flex-col">
          ...
          >
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-xs text-brand-text/40 mt-1">Chưa có dữ liệu chuyến từ backend</p>
            </div>
          </div>
          ...
          <div className="bg-brand-primary text-brand-text rounded-3xl p-6 shadow-sm flex flex-col border border-black/5">
            ...
            <div className="space-y-3">
              <div className="bg-white/60 p-4 rounded-2xl border border-white">
                ...
                <div className="text-xs font-medium text-brand-text/80">Chưa có lịch từ backend</div>
              </div>

              <div className="bg-white/30 p-4 rounded-2xl">
                <div className="text-sm font-bold mb-1">--:-- - --:--</div>
                <div className="text-xs font-medium text-brand-text/70">Chưa có lịch từ backend</div>
              </div>
            </div>
