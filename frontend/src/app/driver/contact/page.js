          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-black/5 relative overflow-hidden">
            ...
            <div className="flex items-center gap-6 relative z-10">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-brand-text">Chưa có điều phối viên</h2>
                <p className="text-sm font-medium text-brand-text/60 mb-2">Chưa có dữ liệu từ backend</p>
