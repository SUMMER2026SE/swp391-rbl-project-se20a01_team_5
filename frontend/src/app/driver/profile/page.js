      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto custom-scrollbar pr-2 pb-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <StatCard icon={ShieldCheck} color="bg-brand-success/20 text-brand-success" value="--" label="Điểm an toàn" />
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-black/5 flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <CredentialCard title="Chưa có dữ liệu bằng lái" subtitle="--" status="--" mark="E" />
              <CredentialCard title="Chưa có dữ liệu sức khỏe" subtitle="--" status="--" icon={ShieldCheck} />
            </div>
          </div>
        </div>
      </div>
