...
import { UserCircle, Map, Clock, ShieldCheck, Mail, Phone, Award, CreditCard } from 'lucide-react';
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto custom-scrollbar pr-2 pb-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-black/5 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="w-32 h-32 rounded-full bg-white border-4 border-white shadow-sm flex items-center justify-center relative z-10 mt-8 mb-4">
            ...
            <div className="w-full flex flex-col gap-3 text-left">
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold">TX-1002</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold">0905 123 456</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-brand-surface rounded-xl">
                ...
                <div>
                  ...
                  <div className="font-bold truncate max-w-[200px]">tainguyen@unibus.vn</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">128</div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">420</div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/5 flex flex-col gap-4">
              ...
              <div>
                <div className="text-3xl font-black text-brand-text">100%</div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-black/5 flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border border-black/5 rounded-2xl p-4 flex items-start gap-4 hover:border-brand-primary transition-colors">
                ...
                <div>
                  <div className="font-bold">GPLX Hạng E</div>
                  <div className="text-sm text-brand-text/60 mt-1">Cấp ngày: 12/05/2022</div>
                  <div className="text-sm font-bold text-brand-success mt-1">Còn hạn (Đến 2027)</div>
                </div>
              </div>
              ...
              <div className="border border-black/5 rounded-2xl p-4 flex items-start gap-4 hover:border-brand-primary transition-colors">
                ...
                <div>
                  <div className="font-bold">Giấy Khám Sức Khỏe</div>
                  <div className="text-sm text-brand-text/60 mt-1">Bệnh viện Đa khoa Đà Nẵng</div>
                  <div className="text-sm font-bold text-brand-success mt-1">Đạt yêu cầu (Cập nhật 01/2026)</div>
                </div>
              </div>
            </div>
