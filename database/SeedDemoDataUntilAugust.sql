...
BEGIN
    ...
    VALUES
        ...
        ('fleet.simulator@unibus.local', '$2a$10$EBx14iAsXMpv3k69BQ5/C.GtzEiFqeMvBuMNanRkwHlwx//7yMzWu', 'Mô phỏng đội xe UniBus', NULL, 'DRIVER', 'INACTIVE', CURRENT_TIMESTAMP, 'NOT_SUBMITTED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    WHERE student_code LIKE 'SV-DEMO-%'
      AND used_on_trip_id IN (SELECT trip_id FROM trips WHERE (notes LIKE 'DEMO_DATA%' OR notes LIKE 'DEMO_FLEET%'));
    ...
    VALUES ('SV-DEMO-MONTH', 70000, 'BANK_TRANSFER', 'PAID', 'DEMO-PAY-MONTH', CURRENT_TIMESTAMP - INTERVAL '1 day', v_monthly_pass_id, 'Thanh toán demo vé tháng')
    ...
    VALUES (v_payment_id, 'SV-DEMO-MONTH', 'Hóa đơn demo vé tháng', 70000, 140000, 70000, 70000, CURRENT_TIMESTAMP - INTERVAL '1 day');
