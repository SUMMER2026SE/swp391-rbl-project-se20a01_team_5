...
public class CoordinatorScheduleController {
    ...
    ApiResponse<Void> deleteSchedule(@PathVariable Integer scheduleId, @RequestParam(required = false) LocalDate date) {
        operationsService.deleteSchedule(scheduleId, date);
